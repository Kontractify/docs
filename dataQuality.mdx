...
- `Shared-duplication`: how similar the response is to other responses for a particular question across respondants
...
While you can use the data quality API to evaluate each response individually, providing a `survey ID`, `question ID`, and `response ID` will help tie together responses across respondants.
