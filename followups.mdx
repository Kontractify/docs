...
You can customize the language used by the AI to generate followups. By default, Aftercare will generate a followup that best matches the user's response.

<Tip>
  Customizing the language can help the AI generate followups that are more
  natural sounding.
</Tip>
