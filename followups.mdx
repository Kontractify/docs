...
- **Enriched**: Aftercare will generate a followup question enriched with metrics about the question / response pair. Use these metrics for disqualification or the end the current line of questioning.
