...
You can customize the language used by the AI to generate followups with the `responseLanguage` parameter. By default, Aftercare will generate a followup that best matches the user's response.
