...
You can customize the language used by the AI to generate followups with the `responseLanguage` parameter. By default, Aftercare will respond in English.

Set response language to `auto_detect` to automatically set the language of the generated follow up question to the language of the user's response.
